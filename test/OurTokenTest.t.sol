...
// ERCs have a function called transferFrom.
// If I want my contract to keep track of how many tokens it has from you
// it needs to be the one to trf the tokens from you to itself
// and you need to allow it to do that
